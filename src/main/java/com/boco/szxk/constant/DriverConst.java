package com.boco.szxk.constant;
...
public class DriverConst {
     ...
     * 播放列表
     */
    public static final int Const_Cmd_PlayLst = 20;
    /**
     * 显示指定播放表
     */
    public static final int Const_Cmd_DisPlayLst = 22;
    /**
     * 控制开关
     */
    public static final int Const_Cmd_ScrOnOff = 4;
    /**
     * 读取CMS当前播放表信息
     */
     ...
     * 控制屏体亮度
     */
    public static final int Const_Cmd_Bright = 6;
    /**
     * 正应答标志'0'
     */
    public static final int Const_Answer_Success = 1;
}
