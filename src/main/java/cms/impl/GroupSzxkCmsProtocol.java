 ...
 *
 */
public class GroupSzxkCmsProtocol {
	 ...
	 * @return
	 */
	private String intTo2SizeString(Integer value) {
		String str = "";
		if (value == null) {
			str = "00";
		} else {
